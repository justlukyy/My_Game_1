...
void GenerateEnemy(Enemy& enemy1,
	...
	SDL_Renderer * gRenderer)
{
	enemy1.LoadFromFile("res/img/enemy/cactus.png", gRenderer);
	enemy2.LoadFromFile("res/img/enemy/cactus.png", gRenderer);
	enemy3.LoadFromFile("res/img/enemy/bat.png", gRenderer);
	{
